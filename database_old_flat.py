...
def create_tables():
    ...
    try:
        ...
        db_cursor.execute("CREATE TABLE legislation_update_reviews (review_id INT AUTO_INCREMENT PRIMARY KEY, document_version_id INT NOT NULL, proposed_changes JSON NOT NULL, reviewed_by VARCHAR(255), reviewed_at DATETIME, status VARCHAR(50) DEFAULT 'PENDING', FOREIGN KEY (document_version_id) REFERENCES document_versions(version_id));")
